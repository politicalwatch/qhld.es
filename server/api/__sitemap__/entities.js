...
/**
 * Dynamic sitemap URL source for entity pages.
 * Returns deputies, parliamentary groups, and topics.
 * Cached server-side for 1h with SWR (data updates at most daily).
 *
...
export default defineCachedEventHandler(
  async (event) => {
    ...
    try {
      ...
      console.warn('[sitemap:entities] Failed to fetch dynamic URLs:', err?.message);
    }
